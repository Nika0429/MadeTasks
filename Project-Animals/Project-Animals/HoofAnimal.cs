...
{
    abstract class HoofAnimal:IDomesticAnimal // Abstract class HoofAnimal, implementor of interface IDomesticAnimal
    {
        ...
        public typeofdigestion  TypeOfDigestion
        {
            get
            {
                return typeOfDigestion;
            }

            set
            {
                typeOfDigestion = value;
            }
        }

        int quantityOfHooves;

        public int QuantityOfHooves
        {
            get
            {
                return quantityOfHooves;
            }
